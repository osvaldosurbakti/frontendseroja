  ...
  return (
    <section className="py-16 bg-white">
      <div className="container mx-auto px-6">
        <h2 className="text-4xl font-bold text-center text-gray-800 mb-12">Hubungi Kami</h2>
        
        {/* Informasi & Kontak */}
        <div className="flex flex-col md:flex-row items-center justify-center gap-10">
          <div className="w-full md:w-1/3 text-center space-y-6">
            <p className="text-gray-600">Kami siap membantu! Jangan ragu untuk menghubungi kami.</p>
            <WhatsAppButton />
            <ContactInfo />
          </div>
        </div>
